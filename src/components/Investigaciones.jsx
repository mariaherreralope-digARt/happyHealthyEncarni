...
const slideColumns = [
  ...
  [
    { title: "Reconocimientos", image: premios1, description: "Premio internacional en innovación educativa: Educación emocional y saludable. En el marco del IB se crea un Programa Interdisciplinar donde se promueve responsabilidad social y gestión emocional fomentando el trabajo cooperativo y la resolución de problemas.", link: null },
  ...
  [
    ...
    { title: "Libros", image: libros2, description: "MINDFULNESS COMO HERRAMIENTA TRANSFORMADORA DEL BIENESTAR. Este libro narra a través de de evidencias científicas los beneficios de la práctica - entrenamiento / de mindfulness. Se aborda a nivel de inteligencia emocional, de salud mental (estrés, ansiedad y depresión) y felicidad (bienestar subjetivo). Una lectura muy apropiada si quieres aprender sobre el entrenamiento de la mente y su repercusión en tu salud holística." },
...
export default function App() {
  return (
    <main id="investigaciones" className="min-h-screen bg-transparent flex flex-col items-center justify-center p-6">
